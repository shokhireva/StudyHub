        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentTasks_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_StudentTasks_Quizzes_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentAnswers_StudentTasks_StudentTaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAnswers_StudentTaskId",
                table: "StudentAnswers",
                column: "StudentTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentTasks_GroupId",
                table: "StudentTasks",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentTasks_QuizId",
                table: "StudentTasks",
                column: "QuizId");
